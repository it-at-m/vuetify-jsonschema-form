    ...
    renderObjectContainer(h) {
      ...
      if (this.subSchemas && this.subSchemas.length) {
        const props = {
          ...
          readonly: this.readonly || (this.subSchemasConstProp && this.subSchemasConstProp.readOnly),
      ...
      return [h('v-row', { class: `ma-0 ${this.fullOptions.objectContainerClass}` }, [
        ...
        this.fullSchema.description && !this.subSchemasConstProp && h('v-col', { props: { cols: 12 }, class: { 'pa-0': true }, attrs: { tabindex: 0 }, domProps: { innerHTML: this.htmlDescription } })]
