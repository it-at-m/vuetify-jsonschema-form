  ...
  methods: {
    ...
    renderArrayItemEditButton(h, item, i, isCurrentInlineEdit) {
      ...
      return h('v-btn', {
        ...
        attrs: { id: this.fullOptions.idPrefix + this.dashKey + '-' + (isNew ? '-add' : i + '--edit') + '-button', 'aria-label': (isNew ? this.label + ' neues Objekt hinzufuegen' : (!isCurrentInlineEdit ? 'Bearbeitungsmodus aktivieren ' + this.label + objectNumber : 'Bearbeitungsmodus deaktivieren ' + this.label + objectNumber)) },
